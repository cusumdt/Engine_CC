...
void Text::set(const char* fontPath)
{
	ShaderProgramSource source = BaseGame::newRenderer.ShaderParser("res/shaders/text.shader");
...
void Text::RenderText(std::string text, float x, float y, float scale, glm::vec3 color)
{
	...
	glm::mat4 projection = glm::ortho(0.0f, (float)m_viewport[2], 0.0f, (float)m_viewport[3]);
