...
uniform int cantLights; //cantidad de pointlights que fueron creadas
#define MAX_LIGHTS 10

uniform bool hasAmbient; //determina si existe una luz ambiente
uniform bool isDirectional; //determina si existe una luz direccional
